...
var x0 = d3.scale.ordinal()
 ...
 // "#98abc5", "#8a89a6", "#7b6888", "#6b486b", "#a05d56", "#d0743c", "#ff8c00"
  var DiseaseCategory = ["Heart Disease","Diabetes", "Kidney Disease", "Asthma", "Skin Cancer"];
 ...
 //         .attr("height", 650)          
  ...
  .append("svg")
   ...
   //.style("display","inline-block");
      ...
      var groups = d3.map(groupInfo, function(d){ console.log(d.AgeGrp); return(d.AgeGrp)}).keys();
      console.log(groups);
      ...
      groupInfo.forEach(function(d) {
          d.disease = diseasegroups.map(function(name) { console.log("name:"+ name+ "value:" +d[name]); return {name: name, value: +d[name]}; });
        });
       ...
       y.domain([
        0,
        d3.max(groupInfo, function(d) { return d3.max(d.disease, function(d) { console.log(d.value); return d.value; }); })])
    ...
    svg.append("g")
        ...
        var ageGrp = svg.selectAll(".ageGrps")
          ...
          .enter().append("g")
            .attr("class", "g")
            .attr("transform", function(d) { console.log(d.AgeGrp); return "translate(" + x0(d.AgeGrp) + ",0)"; });
